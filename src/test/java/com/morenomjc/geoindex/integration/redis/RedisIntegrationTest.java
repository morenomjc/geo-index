package com.morenomjc.geoindex.integration.redis;

import com.fasterxml.jackson.core.type.TypeReference;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.morenomjc.geoindex.api.model.DistanceUnit;
import com.morenomjc.geoindex.integration.AbstractIntegrationTest;
...
import static com.morenomjc.geoindex.utils.TestDataProvider.readStringFromFile;
...
class RedisIntegrationTest extends AbstractIntegrationTest {
	...
	static Stream<Arguments> geoJsonFiles() {
		return Stream.of(of("Point", "1", readStringFromFile(GEOJSON_FOLDER + "Point.json")),
				of("LineString", "2", readStringFromFile(GEOJSON_FOLDER + "LineString.json")),
				of("Polygon", "3", readStringFromFile(GEOJSON_FOLDER + "Polygon.json")));
	}
